...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# IMPORTANTE: Ajusta esta ruta al lugar donde tengas el archivo Excel}
...
El data frame consolidado tiene \textbf{176 filas} (44 comensales
\(\times\) 4 semanas) y \textbf{20 columnas}.
...
\NormalTok{datos }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{kable}\NormalTok{(}\AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\StringTok{"Semana"}\NormalTok{, }\StringTok{"Condición experimental"}\NormalTok{, }\StringTok{"n"}\NormalTok{),}
        \AttributeTok{align    =} \StringTok{"clc"}\NormalTok{,}
...
\NormalTok{estado\_ok }\OtherTok{\textless{}{-}}\NormalTok{ rangos}\SpecialCharTok{$}\NormalTok{Min }\SpecialCharTok{\textgreater{}=} \DecValTok{1} \SpecialCharTok{\&}\NormalTok{ rangos}\SpecialCharTok{$}\NormalTok{Max }\SpecialCharTok{\textless{}=} \DecValTok{5}

\NormalTok{rangos }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Estado =} \FunctionTok{ifelse}\NormalTok{(estado\_ok, }\StringTok{"OK"}\NormalTok{, }\StringTok{"FUERA DE RANGO"}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{column\_spec}\NormalTok{(}\DecValTok{4}\NormalTok{, }\AttributeTok{color =} \FunctionTok{ifelse}\NormalTok{(estado\_ok, }\StringTok{"teal"}\NormalTok{, }\StringTok{"red"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\midrule
P1 & 1 & 5 & \textcolor{teal}{OK}\\
P2 & 1 & 5 & \textcolor{teal}{OK}\\
P3 & 1 & 5 & \textcolor{teal}{OK}\\
S1 & 1 & 5 & \textcolor{teal}{OK}\\
S2 & 1 & 5 & \textcolor{teal}{OK}\\
\addlinespace
S3 & 1 & 5 & \textcolor{teal}{OK}\\
E1 & 1 & 5 & \textcolor{teal}{OK}\\
E2 & 1 & 5 & \textcolor{teal}{OK}\\
E3 & 1 & 5 & \textcolor{teal}{OK}\\
E4 & 1 & 5 & \textcolor{teal}{OK}\\
\addlinespace
E5 & 1 & 5 & \textcolor{teal}{OK}\\
E6 & 1 & 5 & \textcolor{teal}{OK}\\
E7 & 1 & 5 & \textcolor{teal}{OK}\\
E8 & 1 & 5 & \textcolor{teal}{OK}\\
I1 & 1 & 5 & \textcolor{teal}{OK}\\
\addlinespace
I2 & 1 & 5 & \textcolor{teal}{OK}\\
\bottomrule
\end{tabular}
\end{table}
...
\NormalTok{tabla\_i3 }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{kable}\NormalTok{(}\AttributeTok{align    =} \StringTok{"ccc"}\NormalTok{,}
        \AttributeTok{booktabs =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable\_styling}\NormalTok{(}\AttributeTok{latex\_options =} \FunctionTok{c}\NormalTok{(}\StringTok{"hold\_position"}\NormalTok{),}
                \AttributeTok{full\_width =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
...
Se crea I3\_bin (1 = Sí, 0 = No) para facilitar el cálculo de
...
\FunctionTok{table}\NormalTok{(}
  \AttributeTok{Semana =} \FunctionTok{paste}\NormalTok{(}\StringTok{"Semana"}\NormalTok{, datos}\SpecialCharTok{$}\NormalTok{semana),}
  \AttributeTok{Recomendaria =}\NormalTok{ datos}\SpecialCharTok{$}\NormalTok{I3\_factor}
\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{addmargins}\NormalTok{(}\AttributeTok{margin =} \DecValTok{2}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable}\NormalTok{(}\AttributeTok{align    =} \StringTok{"ccc"}\NormalTok{,}
        \AttributeTok{booktabs =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{resumen }\OtherTok{\textless{}{-}}\NormalTok{ datos }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(condicion) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{n            =} \FunctionTok{n}\NormalTok{(),}
    \AttributeTok{Producto\_M   =} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(idx\_producto), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Producto\_DE  =} \FunctionTok{round}\NormalTok{(}\FunctionTok{sd}\NormalTok{(idx\_producto), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Servicio\_M   =} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(idx\_servicio), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Servicio\_DE  =} \FunctionTok{round}\NormalTok{(}\FunctionTok{sd}\NormalTok{(idx\_servicio), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Entorno\_M    =} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(idx\_entorno), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Entorno\_DE   =} \FunctionTok{round}\NormalTok{(}\FunctionTok{sd}\NormalTok{(idx\_entorno), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Satisf\_M     =} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(idx\_satisfaccion), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Satisf\_DE    =} \FunctionTok{round}\NormalTok{(}\FunctionTok{sd}\NormalTok{(idx\_satisfaccion), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Revisitar\_M  =} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(idx\_revisitar), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Revisitar\_DE =} \FunctionTok{round}\NormalTok{(}\FunctionTok{sd}\NormalTok{(idx\_revisitar), }\DecValTok{2}\NormalTok{),}
    \AttributeTok{Recomendar   =} \FunctionTok{round}\NormalTok{(}\FunctionTok{mean}\NormalTok{(I3\_bin) }\SpecialCharTok{*} \DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{),}
    \AttributeTok{.groups =} \StringTok{"drop"}
\NormalTok{  )}

\FunctionTok{cat}\NormalTok{(}\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{begin\{landscape\}}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\toprule
\multicolumn{2}{c}{ } & \multicolumn{2}{c}{Producto} & \multicolumn{2}{c}{Servicio} & \multicolumn{2}{c}{Entorno} & \multicolumn{2}{c}{Satisfacción} & \multicolumn{2}{c}{Revisitar} & \multicolumn{1}{c}{Recom.} \\
...
Condición & n & M & DE & M & DE & M & DE & M & DE & M & DE & \%\\
\midrule
...
\NormalTok{manip }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable}\NormalTok{(}\AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\StringTok{"Condición"}\NormalTok{, }\StringTok{"Producto"}\NormalTok{, }\StringTok{"Servicio"}\NormalTok{, }\StringTok{"Entorno"}\NormalTok{),}
        \AttributeTok{align    =} \StringTok{"lccc"}\NormalTok{,}
        \AttributeTok{booktabs =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable\_styling}\NormalTok{(}\AttributeTok{latex\_options =} \FunctionTok{c}\NormalTok{(}\StringTok{"hold\_position"}\NormalTok{),}
                \AttributeTok{full\_width =} \ConstantTok{FALSE}\NormalTok{)}
...
En la fila ``Producto degradado'' (semana 3), el índice de Producto cae
a 2.72 frente a 3.77 de la base. Análogamente, el Servicio cae a 3.11 en
la semana 2, y el Entorno cae a 2.29 en la semana 4. Las dimensiones no
manipuladas se mantienen en niveles cercanos a la línea base, lo que
confirma que la manipulación experimental fue efectiva.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Capturar la salida de str() y reemplazar \_ por \textbackslash{}\_ para LaTeX}
\NormalTok{salida\_str }\OtherTok{\textless{}{-}} \FunctionTok{capture.output}\NormalTok{(}\FunctionTok{str}\NormalTok{(datos))}
\FunctionTok{cat}\NormalTok{(}\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{begin\{verbatim\}}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(salida\_str, }\AttributeTok{sep =} \StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(}\StringTok{"}\SpecialCharTok{\textbackslash{}n\textbackslash{}\textbackslash{}}\StringTok{end\{verbatim\}}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{table}[!h]
\centering
\begin{tabular}{ll>{\raggedright\arraybackslash}p{9cm}}
\toprule
